                ...
                <div class="category-listing mb-50">
                    ...
                    <div class="single-listing">
                        ...
                        <div class="select-job-items2">
                            <select name="act_Place">
                                <option value="">現場</option>
                                <option value="">線上</option>
                            </select>
                        </div>
                        ...
                        <div class="select-job-items2">
                            <select name="act_Loc">
                                ...
                                <option value="YL">雲林</option>
                                <option value="CY">嘉義</option>
                                <option value="TN">台南</option>
                                <option value="KH">高雄</option>
                                <option value="PT">屏東</option>
                                <option value="YL">宜蘭</option>
                                <option value="HL">花蓮</option>
                                <option value="TT">台東</option>
                                <option value="PH">澎湖</option>
                                <option value="LD">綠島</option>
                                <option value="LY">蘭嶼</option>
                                <option value="KM">金門</option>
                                <option value="MT">馬祖</option>
                                <option value="LC">連江</option>
